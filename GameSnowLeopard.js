        ...
        switch(this.stateCur){
            ...
            case GameState.HUNGARY:
                if(sInput.toLowerCase().match("wait")){
                    ...
                    sReply  =  "You are resting and enjoying the view from the top of a cliff which is 3 meters high. Now you see " 
                            + this.aAnimals[iPreserve-1] + " wondering under the cliff. Would you jump off the cliff to catch it or would you rather stay put?";
                    break;
                }
            ...
            case GameState.NUMBER:
                ...
                if ((nInput >= 10)||(nInput <= 0)) {     // input validation
                    ...
                    else if ((iPreserve==2)||(iPreserve==3)){
                        sReply = "Great you got the " + aAnimals[iPreserve-1] + "! Now you are full. Would you rest near your leftover or walk around to guard your territory."
